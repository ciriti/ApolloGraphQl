...
internal class ForEval private constructor() { companion object }
internal typealias EvalOf<A> = Kind<ForEval, A>
internal inline fun <A> EvalOf<A>.fix(): Eval<A> = this as Eval<A>
internal fun <A> EvalOf<A>.value(): A = this.fix().value()
...
//    }
  ...
  internal fun <B> coflatMap(f: (EvalOf<A>) -> B): Eval<B> =
      Later { f(this) }
